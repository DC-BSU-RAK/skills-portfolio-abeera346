...
class CyberMathApp:
    ...
    def show_difficulty_screen(self):
        ...
        back_btn.place(relx=0.08, rely=0.08, anchor="center")
    ...
    def next_question(self):
        ...
        self.answer_entry.focus_set()   # cursor here
